...
const Messages = () => {
  // Calculate total notifications across all modules
  const totalNotifications = allModuleNotifications.reduce((sum, module) => sum + module.notificationCount, 0);
      ...
      <DropdownMenu>
        ...
        >
          ...
          <SimpleBar className="max-h-96 mt-3">
            {allModuleNotifications.map((module, moduleIndex) => (
